<x-filament-widgets::widget>
    <x-filament::section>
        <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 1rem;">
            ...
            <a
                href="{{ $link['url'] }}"
                style="display: flex; flex-direction: row; align-items: center; gap: 0.625rem; padding: 0.75rem 1rem; border-radius: 0.5rem; text-decoration: none; background: linear-gradient(135deg, rgba(7,50,178,0.06), rgba(26,0,107,0.04)); border: 1px solid rgba(7,50,178,0.12); transition: all 0.2s ease;"
