    ...
    <x-filament::section>
        <div class="grid grid-cols-3 sm:grid-cols-5 gap-3">
            ...
            <a
                ...
                onmouseover="this.style.background='linear-gradient(135deg, #0732b2, #1a006b)'; this.style.transform='translateY(-1px)'; this.querySelector('.ql-icon').style.color='#ffffff'; this.querySelector('.ql-label').style.color='#ffffff';"
                ...
                <span class="ql-icon shrink-0">
                    @svg($link['icon'], 'w-5 h-5 text-primary-500 transition-colors')
                </span>
